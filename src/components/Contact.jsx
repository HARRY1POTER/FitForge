...
//   return (
//     <div>
//       <div className="min-h-scree  n py-52 bg-gray-800  flex flex-col justify-center sm:py-12 ">
...
const Contact = () => {
  return (
    <div className="bg-gray-300 md:p-28 p-5">
      <section className="py-24 bg-orange-400 rounded-xl">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 grid-cols-1 gap-x-24">
            <div className="flex items-center lg:mb-0 mb-10">
              <div className="">
                <h4 className="text-green-800 text-xl font-bold leading-6 mb-4 lg:text-left text-center">
                  Contact Us
                </h4>
                ...
                <form action="">
                  <input
                    type="text"
                    className="w-full h-14 shadow-sm bg-white text-gray-600 placeholder-text-400 text-lg font-normal leading-7 rounded-full border border-gray-200 focus:outline-none py-2 px-4 mb-8"
                    placeholder="Name"
                  />
                  <input
                    type="email"
                  ...
                  ></textarea>
                  <button className="w-full h-12 text-center text-white text-base font-semibold leading-6 rounded-full bg-green-600 shadow transition-all duration-700 hover:bg-green-800">
                    Submit
                  </button>
                </form>
              </div>
            ...
            <div
              style={{
                backgroundImage:
                  "url('/assets/Green Geometric Pattern Vector.jpg')",
              }}
              className="lg:max-w-xl w-full h-[600px] flex items-center justify-center  bg-cover bg-no-repeat "
            >
              <div className="">
                <div className="lg:w- 96 w-auto h-auto bg-white shadow-xl lg:p-6 p-4 m-5">
                  ...
                  <a href="/" className="flex items-center mb-6">
                    ...
                    <h5 className="text-black text-base font-normal leading-6 ml-5">
                      {/* Pagedone1234@gmail.com */}xyz123@gmail.com
                    </h5>
                  </a>
                  <a href="/" className="flex items-center mb-6">
                    <svg
