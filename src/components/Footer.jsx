...
//           <a
//             href="/"
//             className="text-teal-400 hover:underline hover:text-white transition"
//           >
//             codewithsadee.
//           </a>
//         </p>
...
//         {/* Links */}
//         <ul className="flex flex-wrap justify-center md:justify-end items-center gap-4">
//           <li>
//             <a
//               href="/"
//               className="relative text-white hover:text-teal-400 transition before:absolute before:bottom-[-2px] before:left-0 before:w-0 before:h-[2px] before:bg-teal-400 hover:before:w-full before:transition-all before:duration-300"
//             >
//               Privacy Policy
//             </a>
//           </li>
